...
# Sunday, February 01 2015 15:32 - Refactored 2009 "wav to mp3" script into "any to mp3"
# Saturday, March 21 2009 12:12 - Settings for 3.98 to mirror 3.90 settings from 2002...
LAME_OPTS="-m s -q 0 -V 0 -b 32 -B 320 --lowpass -1 --highpass -1"
# Sunday, December 27 2009 14:29 - Autotrim silence from front and back...
SOX_OPTS="-V3 --buffer 10240000 silence 1 1 0.01% reverse silence 1 1 0.01% reverse norm -0.03"
ionice -c3 -p$$

for file in *.{flac,wav,m4a,vob,aac};
do
