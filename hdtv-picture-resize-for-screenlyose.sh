...
# Friday, November 08 2019 - FE - Replace detox with exiftool to rename by date instead, that way resized files are a completely separate naming convention.
# Tuesday, December 10 2019 - FE - Use touch to make new file name more useful.
